...
export function AddComment() {
  ...
  return (
    <form className='pt-16 px-16 pb-12 bg-white rounded'>
      <textarea
        className='mb-16 py-12 pr-12 pl-24 block w-full border border-light-gray border-1 rounded outline-none resize-none'
      ...
      <div className='flex justify-between items-center'>
        ...
        <button
          className='bg-moderate-blue text-white py-12 px-32 rounded'
